...
def count_down(count):
    ...
    '''Before we used "config" for update anything but now we can't,
    Cuz now we have to update a particuler item.
...
'''image can't take any direct path of files, that's why we've to provide a variable as image parameter. '''
